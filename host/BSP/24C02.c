...
#include "includes.h"
uint8_t WriteBuffer[255]={0};
uint8_t ReadBuffer[255]={0};
...
*	@Description    ： 通过I2C通信检查EEPROM是否正常
*	@Author  		： Blade@oarap.org
*	@Date			： 2016-05
*	@param 			： 无
*	@return	(U8) 	： 0-自检正常 BIT4-失败
*****************************************************************************/
u8 I2C_EEPROM_Init()
{//在0地址写入0X5A 0XA5 读取后如果相等则认为自检成功
  ...
  uint16_t Addr;
	...
	I2C_ReadByte(ReadBuffer, 2,0, ADDR_24LC02);
